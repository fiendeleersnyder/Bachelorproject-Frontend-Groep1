    ...
    return (
        <div><p className={classes.card}>Welcome<br/><br/>
            ...
            thesis subject will be open for choosing a master thesis.<br/><br/>
             During this time you will be able to add favorites, add subjects to a
            selection and submit your selection. In your target group you have
            to submit a selection of 3 subjects. Finalize your submission by
            30 April 2022 23:55. After this date the application
